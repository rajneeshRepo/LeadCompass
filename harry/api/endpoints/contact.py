...
from schemas.people import PeopleResponse, PeopleSchema, PeopleUpdateSchema
...
@router.get('/contact/all', response_description="List of contacts", response_model=PeopleResponse, response_model_by_alias=False, status_code=status.HTTP_200_OK)
...
async def create_contact(contact: PeopleSchema):
    try:
        collection_contact = get_contact_collection()
        ...
        new_contact = PeopleSchema(**new_contact)
